...
import { 
  Trophy, LogOut, Plus, Sparkles, Heart, Bookmark, 
  ...
  useEffect(() => {
    ...
    if (userStr) {
      try {
        ...
        const extractedName = parsed.username || parsed.name || parsed.user?.username || parsed.user?.name || parsed.data?.username || parsed.data?.name;
      ...
      <div className="max-w-[1400px] mx-auto px-6 pt-32 relative z-10">
        ...
        <section className="max-w-3xl mb-16">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <button onClick={() => router.push('/builder')} className="bg-transparent border-2 border-[#ff3f6c]/20 text-[#ff3f6c] px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-[#ff3f6c]/5 transition-all">
        ...
        <section className="mb-24">
          <div 
            ...
            className="relative w-full rounded-[2.5rem] p-8 md:p-14 overflow-hidden cursor-pointer group shadow-sm hover:shadow-xl transition-all duration-500 border border-[#FBCFE8]/50 bg-white"
          >
            <div className="absolute -right-20 -top-20 w-80 h-80 bg-[#ff3f6c]/10 rounded-full blur-3xl group-hover:bg-[#ff3f6c]/20 transition-all duration-500" />
            
            <div className="flex flex-col md:flex-row items-center justify-between gap-10 relative z-10">
              <div className="max-w-xl">
                <div className="flex items-center gap-2 text-[#ff3f6c] mb-5">
                  <span className="bg-[#FFF5F8] p-2 rounded-full"><BookOpen className="w-4 h-4" /></span>
                  <span className="text-[10px] font-bold tracking-[0.2em] uppercase">User Guide & Rules</span>
                </div>
                
                <h2 className="text-4xl md:text-5xl font-bold text-[#111111] mb-4 leading-tight" style={{ fontFamily: 'Georgia, serif' }}>
                  Enter <span className="italic text-[#ff3f6c]">Tribe Academy</span>
                </h2>
                
                <p className="text-[#666666] text-base md:text-lg mb-8 leading-relaxed">
                  Learn how our backend automatically filters your feed, how to master the Lookbook Builder, and the secrets to climbing the live leaderboard.
                </p>
                
                <button className="bg-[#111111] text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-[#222222] transition-all group-hover:-translate-y-1">
                  Read the Playbook <ArrowRight className="w-4 h-4" />
                </button>
              </div>
              
              <div className="hidden md:flex flex-col items-center justify-center p-8 bg-[#FFF5F8] rounded-3xl border border-[#FBCFE8]/50 transform group-hover:rotate-2 transition-transform">
                <Sparkles className="w-12 h-12 text-[#E5C07B] mb-4" />
                <p className="font-bold text-[#111111] text-lg">Initiate Bonus</p>
                <p className="text-[#ff3f6c] font-black text-3xl">+100 pts</p>
                <p className="text-xs text-[#888888] mt-2">For completing the guide</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-[#FBCFE8]/30 hover:shadow-md transition-all">
              ...
              <p className="text-sm text-[#666666]">Select, arrange, publish. Editorial-grade.</p>
            </div>
            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-[#FBCFE8]/30 hover:shadow-md transition-all">
